package com.example.library.utils.fragmentdialogutils;
...
import com.example.library.utils.WindowManagerUtils;
...
public class CommonDialogFragment extends DialogFragment {
    ...
    public static CommonDialogFragment instance;
    ...
    public void onStart() {
        ...
        if (dialog != null) {
            ...
            mLp = getActivity().getWindow().getAttributes();
            mLp.alpha = 0.6f;
            getActivity().getWindow().setAttributes(mLp);
    ...
    public  void backgroundRecover(){
        WindowManagerUtils.removeWindow();
        mLp.alpha = 1.0f;
        getActivity().getWindow().setAttributes(mLp);
        getActivity().getWindow().addFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
